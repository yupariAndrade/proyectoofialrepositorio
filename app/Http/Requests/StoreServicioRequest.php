...
class StoreServicioRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'imagenReferencia.required' => 'La imagen de referencia es obligatoria.',
