            ...
            <div class="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black">
                ...
                <header class="bg-gradient-to-r from-slate-800/50 to-slate-900/50 backdrop-blur-lg border-b border-white/10 px-8 py-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-3xl font-bold bg-gradient-to-r from-amber-400 via-pink-400 to-purple-400 bg-clip-text text-transparent mb-2">➕ Nuevo Estado de Trabajo</h1>
                            <p class="text-slate-300">Registra un nuevo estado para los trabajos</p>
                        </div>
                            ...
                            <form @submit.prevent="submit" class="space-y-6">
                                ...
                                <div class="bg-gradient-to-r from-slate-700/30 to-slate-800/30 rounded-xl p-6 border border-white/10">
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                        <div class="bg-amber-500/20 border border-amber-500/30 rounded-lg p-3 text-center">
                                            <span class="text-amber-400 font-medium text-sm">Pendiente</span>
                                        </div>
                                        <div class="bg-blue-500/20 border border-blue-500/30 rounded-lg p-3 text-center">
                                            <span class="text-blue-400 font-medium text-sm">En Proceso</span>
                                        </div>
                                        <div class="bg-green-500/20 border border-green-500/30 rounded-lg p-3 text-center">
                                            <span class="text-green-400 font-medium text-sm">Completado</span>
                                        </div>
                                        <div class="bg-red-500/20 border border-red-500/30 rounded-lg p-3 text-center">
                                            <span class="text-red-400 font-medium text-sm">Cancelado</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center justify-end space-x-4 pt-6 border-t border-white/10">
                                    ...
                                    >
                                        ...
                                        {{ form.processing ? 'Creando...' : 'Crear Estado' }}
                                    </button>
                                </div>
                            </form>
                        </div>
