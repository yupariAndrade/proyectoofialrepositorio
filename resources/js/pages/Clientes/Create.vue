      ...
      <div class="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black">
        ...
        <div class="bg-gradient-to-r from-slate-800/50 to-slate-900/50 backdrop-blur-lg border-b border-white/10 py-12 px-8">
          <div class="max-w-7xl mx-auto flex items-center justify-between">
            <div>
              <h1 class="text-4xl font-bold bg-gradient-to-r from-amber-400 via-pink-400 to-purple-400 bg-clip-text text-transparent mb-3">➕ Crear Nuevo Cliente</h1>
              <p class="text-slate-300 text-lg">Registra un nuevo cliente en el sistema</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-8">
              ...
              <div class="flex items-center justify-between pt-8 border-t border-slate-600/50">
                ...
                >
                  ...
                  {{ form.processing ? 'Registrando...' : 'Crear Cliente' }}
                </button>
              </div>
            </form>
          </div>
